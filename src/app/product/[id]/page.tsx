...
import RateC from "@/components/RateC";
import FormatPrice from "@/utils/formatPrice";
import CopyCodeButton from "@/components/CopyCodeButton";
import { useEffect, useState } from "react";
import SizeGuide from "@/components/product/SizeGuide";
import CustomPaging from "@/components/product/CustomPaging";
import NumberSpinner from "@/components/product/NumberSpinner";

//image
import zaloPay from '../../../../public/images/zalopay.webp'
import visa from '../../../../public/images/visa-card.webp'
import masterCard from '../../../../public/images/master-card.webp'
import vnPay from '../../../../public/images/vnpay-qr.webp'
                    ...
                    <div className="py-2">
                        ...
                        <div className="flex gap-2">
                            {product.colors.map((item) => (
                                <div
                                    className={`${selectedColor === item.color ? 'border border-slate-900 ' : ''} flex items-center justify-center rounded-full bg-[#ca8d3e] h-10 w-10 hover:border hover:border-slate-900`}
